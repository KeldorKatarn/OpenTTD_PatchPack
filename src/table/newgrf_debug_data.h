...
class NIHVehicle : public NIHelper {
	bool IsInspectable(uint index) const                 { return Vehicle::Get(index)->GetGRF() != nullptr; }
...
class NIHStation : public NIHelper {
	bool IsInspectable(uint index) const                 { return GetStationSpec(index) != nullptr; }
	uint GetParent(uint index) const                     { return GetInspectWindowNumber(GSF_FAKE_TOWNS, Station::GetByTile(index)->town->index); }
	const void *GetInstance(uint index)const             { return nullptr; }
...
class NIHHouse : public NIHelper {
	bool IsInspectable(uint index) const                 { return HouseSpec::Get(GetHouseType(index))->grf_prop.grffile != nullptr; }
...
class NIHIndustryTile : public NIHelper {
	bool IsInspectable(uint index) const                 { return GetIndustryTileSpec(GetIndustryGfx(index))->grf_prop.grffile != nullptr; }
...
class NIHIndustry : public NIHelper {
	bool IsInspectable(uint index) const                 { return GetIndustrySpec(Industry::Get(index)->type)->grf_prop.grffile != nullptr; }
...
class NIHObject : public NIHelper {
	bool IsInspectable(uint index) const                 { return ObjectSpec::GetByTile(index)->grf_prop.grffile != nullptr; }
...
class NIHRailType : public NIHelper {
	...
	const void *GetInstance(uint index)const             { return nullptr; }
	const void *GetSpec(uint index) const                { return nullptr; }
...
class NIHAirportTile : public NIHelper {
	bool IsInspectable(uint index) const                 { return AirportTileSpec::Get(GetAirportGfx(index))->grf_prop.grffile != nullptr; }
	uint GetParent(uint index) const                     { return GetInspectWindowNumber(GSF_FAKE_TOWNS, Station::GetByTile(index)->town->index); }
	const void *GetInstance(uint index)const             { return nullptr; }
