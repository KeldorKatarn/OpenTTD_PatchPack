...
public:
	 ...
	 * @return the vehicle's running cost
	 */
	Money GetDisplayRunningCost() const { return (this->GetRunningCost() >> 8) * _settings_game.economy.daylength; }
	...
	*/
	inline bool HasOrdersList() const { return this->orders.list != nullptr; }

	/**
	 * Check if we share our orders with another vehicle.
	 * @return true if there are other vehicles sharing the same order
	 */
	inline bool HasSharedOrdersList() const { return this->orders.list != nullptr && this->orders.list->IsShared(); }
...
public:
	...
	*         \li nullptr  if the vehicle won't stop anymore or there is no orders list.
	*/
