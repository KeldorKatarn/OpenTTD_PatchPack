...
static const NWidgetPart _vehicle_trip_history_widgets[] = {
	...
	NWidget(NWID_HORIZONTAL),
		...
		NWidget(NWID_VERTICAL),
			...
			NWidget(WWT_MATRIX, COLOUR_GREY, VTH_MATRIX_PERCHANGE), SetMinimalSize(50, 0), SetMatrixDataTip(1, 10, STR_NULL), SetResize(1, 1),SetFill(1, 0),
		EndContainer(),
		NWidget(NWID_VERTICAL),
			...
			NWidget(WWT_MATRIX, COLOUR_GREY, VTH_MATRIX_TBT), SetMinimalSize(70, 0), SetMatrixDataTip(1, 10, STR_NULL), SetResize(1, 1),SetFill(1, 0),
		EndContainer(),
		NWidget(NWID_VERTICAL),
			...
			NWidget(WWT_MATRIX, COLOUR_GREY, VTH_MATRIX_DAYCHANGE), SetMinimalSize(50, 0), SetMatrixDataTip(1, 10, STR_NULL), SetResize(1, 1),SetFill(1, 0),
		EndContainer(),
	EndContainer(),
