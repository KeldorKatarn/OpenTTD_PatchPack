/* $Id: fileio.cpp 26114 2013-11-25 21:50:54Z rubidium $ */
...
bool FileExists(const char *filename)
{
	...
	HANDLE hand = CreateFile(OTTD2FS(filename), 0, 0, nullptr, OPEN_EXISTING, 0, nullptr);
 ...
 * @param filesize [out] If not \c nullptr, size of the opened file.
...
void DeterminePaths(const char *exe)
{
	...
	if (!FileExists(_searchpaths[SP_AUTODOWNLOAD_DIR]))  {
		...
		_searchpaths[SP_AUTODOWNLOAD_DIR] = nullptr;
	}
