...
const SaveLoad *GetGoodsDesc()
{
	static const SaveLoad goods_desc[] = {
		...
		SLEG_CONDVAR(            _num_flows,             SLE_UINT32,                183, SL_MAX_VERSION),
		 ...
		 SLE_CONDVAR(GoodsEntry, last_unprocessed_speed, SLE_UINT16, SL_PATCH_PACK_1_12, SL_MAX_VERSION),
		 SLE_CONDVAR(GoodsEntry, last_vehicle_type,      SLE_UINT8,  SL_PATCH_PACK_1_12, SL_MAX_VERSION),
		SLE_END()
	};
