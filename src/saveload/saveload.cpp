 ...
 *  267   SL_PATCH_PACK_1_9
 *  268   SL_PATCH_PACK_1_10
 ...
 *  275   SL_PATCH_PACK_1_18_3
 *  276   SL_PATCH_PACK_1_18_4
 *  277   SL_PATCH_PACK_1_18_6
 *  278   SL_PATCH_PACK_1_19
 *  279   SL_PATCH_PACK_1_20
 *  280   SL_PATCH_PACK_1_21
 *  281   SL_PATCH_PACK_1_22
 *  282   SL_PATCH_PACK_1_23
 *  283   SL_PATCH_PACK_1_24
 *  284   SL_PATCH_PACK_1_25
 *  285   SL_PATCH_PACK_1_26
 *  286   SL_PATCH_PACK_1_27
 */
extern const uint16 SAVEGAME_VERSION = SL_PATCH_PACK_1_27; ///< Current savegame version of OpenTTD.
...
static AsyncSaveFinishProc _async_save_finish = nullptr; ///< Callback to call when the savegame loading is finished.
...
static void SetAsyncSaveFinish(AsyncSaveFinishProc proc)
{
	...
	while (_async_save_finish != nullptr) CSleep(10);
...
{
	if (_async_save_finish == nullptr) return;

	_async_save_finish();

	_async_save_finish = nullptr;

	if (_save_thread != nullptr) {
		_save_thread->Join();
		delete _save_thread;
		_save_thread = nullptr;
	}
}
...
static void *IntToReference(size_t index, SLRefType rt)
{
	...
	switch (rt) {
		...
		case REF_ORDER:
			...
			if (IsSavegameVersionBefore(5, 2)) return nullptr;
...
void WaitTillSaved()
{
	if (_save_thread == nullptr) return;
...
static SaveOrLoadResult DoSave(SaveFilter *writer, bool threaded)
{
	...
	SaveFileStart();
	if (!threaded || !ThreadObject::New(&SaveFileToDiskThread, nullptr, &_save_thread, "ottd:savegame")) {
