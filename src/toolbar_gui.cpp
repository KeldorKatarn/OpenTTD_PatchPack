...
static CallBackFunction ToolbarOptionsClick(Window *w)
{
	...
	*list->Append() = new DropDownListCheckedItem(STR_SETTINGS_MENU_RAIL_FENCES,          OME_RAIL_FENCES, false, HasBit(_display_opt, DO_RAIL_FENCES));
...
{
	PopupMainToolbMenu(w, _game_mode == GM_EDITOR ? (int)WID_TE_HELP : (int)WID_TN_HELP, STR_ABOUT_MENU_LAND_BLOCK_INFO, _settings_client.gui.newgrf_developer_tools ? 16 : 13);
	return CBF_NONE;
}
