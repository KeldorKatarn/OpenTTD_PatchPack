...
enum PacketUDPType {
	...
	PACKET_UDP_SERVER_RESPONSE,			///< Reply of the game server with game information, without the NewGRFs
	PACKET_UDP_SERVER_NEWGRF_RESPONSE,	///< Reply of the game server with newGRF game information. Several of those can be sent.
...
public:
	...
	std::list<std::shared_ptr<Packet>> SendNetworkGameNewGrfInfo(PacketType packet_type, const NetworkGameInfo *info);
	void ReceiveNetworkGameInfo(Packet *p, NetworkGameInfo *info);
	void ReceiveNetworkGameNewGrfInfo(Packet *p, NetworkGameInfo *info);
};
